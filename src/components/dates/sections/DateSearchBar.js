...
import styles from './DateSearchBar.module.css';

const statusTabs = [
  { id: 'all', label: 'Tous les dates' },
...
const DateSearchBar = ({ searchTerm, setSearchTerm, statusFilter, setStatusFilter, statusDetailsMap, filteredCount, totalCount }) => {
    ...
    <div className={styles.filtersContainer}>
      <div className={styles.searchBox}>
        ...
        <input
          ...
          placeholder="Rechercher un date par titre, lieu, contact..."
          value={searchTerm}
