 ...
 * @example
 * ```javascript
 * const { data, loading, error, actions } = useGenericEntityForm(entityType, formConfig, validationRules);
 * 
 * // Utilisation basique
 ...
 */
const useGenericEntityForm = (entityType, formConfig, validationRules) => {
  // États de base
