// src/components/dates/desktop/sections/DateLieuMap.js
import React from 'react';
import styles from './DateLieuMap.module.css';

/**
 * Composant carte Google Maps pour afficher le lieu d'un date
 * Utilise l'iframe Google Maps comme dans l'ancienne version
 */
function DateLieuMap({ lieu, onDirections }) {
  console.log('[DateLieuMap] Lieu reçu:', lieu);
    ...
    return (
      <div className={styles.mapPlaceholder}>
        <div className={styles.mapContent}>
          ...
          <p className={styles.mapTitle}>{lieu?.nom || 'Lieu du date'}</p>
