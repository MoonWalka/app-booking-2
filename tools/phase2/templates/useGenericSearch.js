 ...
 * - history
 * 
 * @param {Object} searchConfig - Configuration principale
 ...
 * @example
 * ```javascript
 * const { data, loading, error, actions } = useGenericSearch(searchConfig, searchFields, options);
 * 
 * // Utilisation basique
 ...
 */
const useGenericSearch = (searchConfig, searchFields, options) => {
  // États de base
