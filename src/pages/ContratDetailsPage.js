...
const ContratDetailsPage = ({ autoDownload = false }) => {
  ...
  const {
    ...
    actionError,
    isActionLoading
  } = useContratActions(contratId, contrat, setContrat, date, contact || programmateur, refresh);
  ...
  }, [searchParams, loading, contrat, showPdfViewer, contratId, navigate, togglePdfViewer, setPreviewType, generatePDFPreview, date, template, contact, programmateur, lieu, artiste, entreprise, structure]);
  ...
  const pdfData = React.useMemo(() => ({
    ...
    entreprise,
    structure
  }), [contrat, date, template, contact, programmateur, lieu, artiste, entreprise, structure]);
  ...
  }, [autoDownload, loading, contrat, date, template, contact, lieu, artiste, isDownloading, autoDownloadTriggered, handleDownload]);
    ...
    <div className={styles.container}>
      ...
      {showDeleteModal && contrat && (
        <Modal show={showDeleteModal} onHide={handleCancelDelete} centered>
          ...
          <Modal.Body>
            <p>Êtes-vous sûr de vouloir supprimer le contrat pour "{contrat.nom || date?.titre || 'ce contrat'}" ?</p>
