...
import styles from './DateOrganizerSection.module.css';
import Button from '@/components/ui/Button';
import Alert from '@/components/ui/Alert';
import Card from '@/components/ui/Card';

/**
 * Composant pour la section Contact du détail d'un date
 * Adapté de la maquette datedetail.md
 */
const DateOrganizerSection = ({
  dateId,
  contact,
  isEditMode,
  selectedContact,
    ...
    >
        {isEditMode ? (
          ...
          <Alert variant="warning">
            Aucun contact n'est associé à ce date.
          </Alert>
        )}
    </Card>
  );
...
export default DateOrganizerSection;