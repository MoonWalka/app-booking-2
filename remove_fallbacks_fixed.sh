...
# Script pour supprimer les fallbacks CSS
# Usage: ./remove_fallbacks_fixed.sh [--dry-run]

echo "⚙️ Suppression des fallbacks CSS..."
...
# Exécuter le script amélioré de suppression des fallbacks
node remove_css_fallbacks_fixed.js --path=src/ $DRY_RUN
