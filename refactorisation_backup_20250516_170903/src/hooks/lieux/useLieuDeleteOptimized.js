// src/hooks/lieux/useLieuDeleteOptimized.js
 ...
 */
const useLieuDeleteOptimized = (onDeleteSuccess) => {
  ...
  const {
    ...
    onError: (error) => {
      console.error('[useLieuDeleteOptimized] Erreur de suppression:', error);
  ...
  const canDeleteLieu = useCallback(async (id) => {
    ...
    try {
      ...
      console.error('[useLieuDeleteOptimized] Erreur de vérification:', error);
...
export default useLieuDeleteOptimized;