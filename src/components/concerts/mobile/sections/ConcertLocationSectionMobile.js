...
import styles from './ConcertLocationSectionMobile.module.css';

/**
 * Section Lieu de la fiche concert pour mobile
 * Affiche les informations du lieu ou permet de les modifier
 */
const ConcertLocationSectionMobile = ({
  concertId,
  lieu,
  isEditMode,
  selectedLieu,
...
export default ConcertLocationSectionMobile;