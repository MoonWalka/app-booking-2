...
import styles from './DateArtistSectionMobile.module.css';

/**
 * Section Artiste de la fiche date pour mobile
 * Affiche les informations de l'artiste ou permet de les modifier
 */
const DateArtistSectionMobile = ({
  dateId,
  artiste,
  isEditMode,
  selectedArtiste,
...
export default DateArtistSectionMobile;