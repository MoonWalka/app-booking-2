...
import styles from './ConcertGeneralInfoMobile.module.css';

/**
 * Affiche les informations générales d'un concert en version mobile
 */
const ConcertGeneralInfoMobile = ({
  concert,
  isEditMode,
  formData,
  onChange,
  ...
  // Options pour le statut du concert
  const statutOptions = [
          ...
          <Card.Body>
            ...
            <Form.Group className={styles.formGroup}>
              ...
              <Form.Control
                ...
                onChange={onChange}
                placeholder="Notes concernant le concert"
        ...
        <Card className={styles.infoCard}>
          <Card.Body>
            ...
            <div className={styles.statusContainer}>
              <Badge 
                bg={getStatusBadgeVariant(concert.statut)}
            ...
            {concert.titre && (
              <div className={styles.infoGroup}>
                ...
                <span className={styles.infoValue}>{concert.titre}</span>
              </div>
            )}
            ...
            <div className={styles.infoGroup}>
              ...
              <span className={`${styles.infoValue} ${isDatePassed(concert.date) ? styles.passedDate : ''}`}>
                {formatDate(concert.date)}
                {isDatePassed(concert.date) && (
...
export default ConcertGeneralInfoMobile;