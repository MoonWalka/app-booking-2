...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-6">
            ...
            <a href="#programmateurs" class="sidebar-link flex items-center py-3 px-4" onclick="showTab('programmateurs')">
            ...
            <a href="#artistes" class="sidebar-link flex items-center py-3 px-4 active" onclick="showTab('artistes')">
    ...
    <div class="main-content">
        ...
        <!-- Programmateurs -->
        <div id="programmateurs" class="tab-content">
            <div class="section-header">
        ...
        <!-- Artistes -->
        <div id="artistes" class="tab-content active">
            <div class="section-header">
