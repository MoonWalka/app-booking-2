// src/hooks/artistes/useDeleteArtisteOptimized.js
 ...
 */
const useDeleteArtisteOptimized = (onDeleteSuccess) => {
  ...
  const {
    ...
    onError: (error) => {
      console.error('[useDeleteArtisteOptimized] Erreur de suppression:', error);
  ...
  const canDeleteArtiste = useCallback(async (artisteId) => {
    ...
    try {
      ...
      console.error('[useDeleteArtisteOptimized] Erreur de vérification:', error);
...
export default useDeleteArtisteOptimized;